...
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports gen_rst]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {gen_sc[0]}]
set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports {gen_sc[1]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {gen_sc[2]}]
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {gen_sc[3]}]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {gen_sc[4]}]
...
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {port_cc[6]}]
set_property -dict {PACKAGE_PIN R10 IOSTANDARD LVCMOS33} [get_ports {port_cc[5]}]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {port_cc[4]}]
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33} [get_ports {port_cc[3]}]
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports {port_cc[2]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {port_cc[1]}]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports {port_cc[0]}]
...
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/ones_place_reg[1]/C}] -timestamp "Mon Oct 23 23:00:31 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/ones_place_reg[2]/C}] -timestamp "Mon Oct 23 23:00:39 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/ones_place_reg[3]/C}] -timestamp "Mon Oct 23 23:00:47 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/tens_place_reg[0]/C}] -timestamp "Mon Oct 23 23:00:54 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/tens_place_reg[1]/C}] -timestamp "Mon Oct 23 23:01:00 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/tens_place_reg[2]/C}] -timestamp "Mon Oct 23 23:01:07 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins {CHP/tens_place_reg[3]/C}] -timestamp "Mon Oct 23 23:01:14 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins REFRESH/refreshcounter_reg/C] -timestamp "Mon Oct 23 23:01:20 GMT 2023"
create_waiver -type METHODOLOGY -id {TIMING-18} -user "hammj" -desc "temp" -timestamp "Mon Oct 23 23:01:33 GMT 2023"

create_waiver -type METHODOLOGY -id {TIMING-17} -user "hammj" -desc "temp" -objects [get_pins { CHP/ones_place_reg[0]/C }] -timestamp "Thu Oct 26 01:07:38 GMT 2023"
